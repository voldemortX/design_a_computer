...
read_verilog -library xil_defaultlib D:/pingpong2/pingpong2.srcs/sources_1/new/memorycontrol.v
...
synth_design -top memorycontrol -part xc7a15tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef memorycontrol.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file memorycontrol_utilization_synth.rpt -pb memorycontrol_utilization_synth.pb"

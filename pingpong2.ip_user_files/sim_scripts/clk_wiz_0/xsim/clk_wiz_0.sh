...
#
# Generated by Vivado on Mon Jul 09 09:49:51 +0800 2018
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:mySim:Functional:clk_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/sw/vivado_pro/Vivado/2018.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
